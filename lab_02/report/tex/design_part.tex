...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{std}
...
Схема алгоритма умножения матриц Винограда представлена на рисунках \ref{fig:vin} и \ref{fig:vin2}.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{vin}
	\caption{Схема алгоритма умножения матриц Винограда часть 1}
	\label{fig:vin}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{vin2}
	\caption{Схема алгоритма умножения матриц Винограда часть 2}
	\label{fig:vin2}
\end{figure}
...
Схема оптимизированного алгоритма умножения матриц Винограда представлена на рисунках \ref{fig:opt} и \ref{fig:opt2}.(Двоичный сдвиг вместо умножения на 2, введение декремента при вычислении вспомогательных массивов, выделение начальной итерации из каждого внешнего цикла)

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{opt}
	\caption{Схема оптимизированного алгоритма умножения матриц Винограда часть 1}
	\label{fig:opt}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{vin2}
	\caption{Схема оптимизированного алгоритма умножения матриц Винограда часть 2}
	\label{fig:opt2}
\end{figure}
